...
const Cart = ({
  ...
  const cartClass =
    "transition-transform duration-300 flex flex-col w-[440px] p-6 min-h-screen bg-[#FBFEF9] fixed right-0 top-0 border-2 border-black -order-1";
  ...
  return (
    <div
      className={!showCart ? `${cartClass} translate-x-[100%]` : cartClass}
